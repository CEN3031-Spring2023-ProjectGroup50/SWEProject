...
func MealGetByDate() gin.HandlerFunc {
	...
	return func(c *gin.Context) {
		...
		initialize.Db.Table("meals").Select("meals.mid, meals.userid, meals.recipeid, meals.date, meals.mealtype, recipe.title, recipe.ingredients, recipe.instructions, recipe.image_name, users.email, recipe.image").
