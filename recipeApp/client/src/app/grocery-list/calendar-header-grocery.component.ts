...
@Component({
  selector: 'mwl-calendar-header-grocery',
  templateUrl: './calendar-header-grocery.component.html',
  styleUrls: ["../../../node_modules/bootstrap/dist/css/bootstrap.min.css", './grocery-list.component.css'],
})
export class CalendarHeaderGroceryComponent {
